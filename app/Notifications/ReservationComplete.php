...
class ReservationComplete extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                    ...
                    ->line('Thankyou for registering to ' . $this->reservation->event->event_name . '.')
                    ->line('Your registration details are as follows:')
                    ...
                    ->line('Address: ' . $this->reservation->address. ' ' . $this->reservation->city . ' ' . $this->reservation->province . ' ' . $this->reservation->postal_code)
